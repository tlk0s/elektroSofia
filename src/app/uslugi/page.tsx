...
export const metadata: Metadata = generateMeta({
  title: 'Електрически услуги София | Николов инженеринг',
      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-10">
          ...
          <div className="space-y-3 text-gray-600 leading-relaxed text-sm">
            <p>
              Николов инженеринг предлага пълен обхват от електротехнически услуги в София — от аварийна помощ при скъсана фаза до цялостна нова инсталация при ремонт. Работим с жилищни, офисни и промишлени обекти в целия град.
            </p>
            <p>
