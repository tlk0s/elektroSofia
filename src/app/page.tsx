    ...
    <>
      ...
      <section className="py-14 bg-white">
        <div className="mx-auto max-w-4xl px-4">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Електротехник в София — защо Николов инженеринг?</h2>
          <div className="space-y-4 text-gray-600 leading-relaxed">
            <p>
              Търсите надежден електротехник в София за смяна на табло, нова инсталация или авариен ремонт? Николов инженеринг работи в столицата от над 15 години и е изпълнил стотици обекта — от смяна на контакт в апартамент до цялостна електроинсталация на търговски обект.
            </p>
            <p>
            ...
            <p>
              Работим в всички квартали на София —{' '}
              {[
                ['Люлин', 'lyulin'],
                ['Младост', 'mladost'],
                ['Витоша', 'vitosha'],
                ...
                <span key={slug}>
                  <a href={`/kvartali/${slug}/`} className="underline hover:text-blue-900">{name}</a>
                  {i < arr.length - 1 ? ', ' : ' и другите'}
                </span>
              ))}
              . Аварийният ни екип е на разположение 24 часа в денонощието, 7 дни в седмицата, с реакция до 60 минути.
            </p>
            <p>
