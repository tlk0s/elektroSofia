...
function ViberIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 512 512" aria-hidden="true">
      ...
      <path fill="#fff" d="M389.7 120.1C357.3 90.5 311.4 75 256.2 75h-.4C200.2 75 154 90.5 121.3 120.1 91 148.4 74.5 187.3 73.9 233.6c-.5 36.4 10.3 70.5 31.2 98.1v47.5c0 5.7 4.6 10.3 10.3 10.3h47.8c27.6 21 59.8 31.9 93.4 31.9h.4c38.4 0 74.9-13.5 103.5-38.1 31-26.7 49.8-64.2 52.9-105.5 3.3-44.3-8.9-87.3-23.7-158.7zm-39.3 219.4c-24.9 23-56.5 35.7-88.2 35.7h-.3c-29.8 0-58.3-9.4-82.4-27.1l-3.6-2.6H133v-43.9l-2.6-3.6c-17.6-24.3-26.9-52.9-26.4-82.9.5-38.8 14-70.7 39-92.5 25.3-22 60.2-33.5 101-33.5h.4c40.8 0 75.7 11.5 101 33.5 23.8 21 38.1 51.7 38.8 82.6.1 1.2.2 2.4.2 3.7.1 34.9-12.7 100.3-33 128.6z"/>
      <path fill="#fff" d="M311.8 296.5l-17.3-10c-5.2-3-11-4.6-16.9-4.6-6.5 0-12.8 1.9-18.2 5.5-4 2.6-8.5 6.6-13.5 12.1-26.5-9.8-57.4-40.7-67.2-67.2 5.5-5 9.5-9.5 12.1-13.5 5.1-7.8 6.4-17.5 3.4-26.4l-9.7-29.6c-2.7-8.1-9.6-13.7-18.2-14.5-1.2-.1-2.5-.2-3.7-.2-8 0-15.7 2.8-21.8 8-8.4 7.2-13.5 16.8-14.6 27.6-3.3 33.1 14.3 77.8 50.8 114.3 36.5 36.5 81.2 54.1 114.3 50.8 10.8-1.1 20.4-6.2 27.6-14.6 7.4-8.6 9.8-19.9 6.5-30.5-1.1-3.7-4.1-6.4-13.6-7.2z"/>
    </svg>
  )
}
...
function EmailIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 512 512" aria-hidden="true">
      ...
      <path fill="#fff" d="M96 160h320v192a32 32 0 0 1-32 32H128a32 32 0 0 1-32-32V160zm160 110 152-110H104l152 110z"/>
    </svg>
  )
}
